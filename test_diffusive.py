...
def sample_and_test(args):
    ...
    for iteration, (x , y) in enumerate(data_loader): 
        ...
        torchvision.utils.save_image(print_list, '{}/sample2_{}.jpg'.format(save_dir, files_name[iteration]), normalize=True)
        
        loss1[0, iteration] = ssim(fake_sample2, real_data)
        loss2[0, iteration] = psnr(fake_sample2, real_data).cpu().numpy()
        print(str(iteration))
        

    print('SSIM: ',np.nanmean(loss1))
    np.save('{}/ssim.npy'.format(save_dir), loss1)

    print('PSNR: ',np.nanmean(loss2))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--exp', default='trial3', help='name of experiment')
    parser.add_argument('--input_path', default='/home/NAS_mount2/jwkim/data/SpineWeb_syn_mat128 --output_path /home/NAS_mount2/jwkim/results/syndiff_adn', help='path to input data')
    ...
    parser.add_argument('--file_name_path', type=str, default='/home/NAS_mount2/jwkim/data/SpineWeb_syn128/ValA')
